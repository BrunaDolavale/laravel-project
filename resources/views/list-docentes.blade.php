...
<div class="row">
  <div class="col-md-12">   
    <br />
    <h4 id="center"><b>DOCENTES CADASTRADOS ({{$total}})</b></h4>
    <br>
    <div class="table-responsive">
      <table class="table table-hover">
        ...
        <tbody>
          ...
          <tr>
            <td id="center">{{$docente->id}}</td>
            <td title="Nome">{{$docente->nome}}</td>
            <td title="Nivel">{{$docente->nivel}}</td>
            <td title="Quantidade" id="center">{{$docente->quantity}}</td>
            <td id="center">
